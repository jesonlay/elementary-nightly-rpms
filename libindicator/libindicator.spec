...
# Create empty indicator directory
mkdir -p %{buildroot}/%{_libdir}/indicators3/7/
...
%changelog
* Mon Sep 07 2015 Fabio Valentini <decathorpe@gmail.com> - 12.10.1-5
- Package empty indicator directory specified in pkgconfig file.
