...
Version:        0.23+git%{date}.%{rev}
Release:        1%{?dist}
URL: https://www.freedesktop.org/software/desktop-file-utils
Source0: https://www.freedesktop.org/software/desktop-file-utils/releases/%{name}-%{version}.tar.gz
...
%changelog
* Tue Sep 27 2016 Fabio Valentini <decathorpe@gmail.com> - 0.23+git160820.103657.5b88c95c-1
